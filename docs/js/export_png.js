...
WK.exportPng = (() => {
  ...
  function dialog() {
    ...
    // Zeile nur fuer Rasterformate. Als Referenz halten: der Dialog haengt erst am Ende im Dokument,
    // ein getElementById vorher liefert null (daran scheiterte das Oeffnen des Export-Dialogs).
    const rasterZeile = U.el('div', { class: 'zeile', id: 'ex-raster' }, U.el('label', {}, 'Auflösung'), faktor, U.el('label', {}, 'Größe'), groesse);
    const zeilen = U.el('div', { class: 'spalten' },
      U.el('div', {}, U.el('div', { class: 'zeile' }, U.el('label', {}, 'Format'), fmt), rasterZeile, U.el('div', { class: 'zeile' }, U.el('label', {}, 'Titel'), titel), U.el('div', { class: 'zeile' }, U.el('label', {}, 'Panel-Buchstabe'), buchstabe)),
