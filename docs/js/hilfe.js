...
WK.hilfe = (() => {
  const U = WK.util;
  const KUERZEL = [
    ['F', 'Suche fokussieren'], ['E', 'Export-Dialog'], ['C', 'Farbeditor'], ['R', 'Rangliste anstelle des Menüs öffnen / schließen'], ['M', 'Fehler oder Feedback melden'], ['D', 'Detailpanel ein-/ausblenden'],
